    ...
    <div className="flex min-h-screen bg-[var(--cream)]">
      ...
      <main className="flex-1 p-6 md:p-10 max-w-6xl">
        ...
        <div className="bg-white rounded-2xl border-2 border-stone-200 shadow-sm overflow-hidden">
          <div className="p-4 bg-[var(--maroon)] text-[var(--gold-bright)] font-marathi font-bold text-sm flex items-center justify-between">
          ...
          {loading ? (
            ...
            <div className="py-16 text-center text-stone-400 font-marathi">
              ...
              अद्याप कोणतीही चौकशी प्राप्त झालेली नाही.
            </div>
          ) : (
            <div className="divide-y divide-stone-100">
              {inquiries.map(inq => {
                ...
                return (
                  <div key={inq.id} className="p-4 md:p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:bg-stone-50 transition-colors">
                      ...
                      <div className="flex items-center gap-2 text-xs font-semibold text-stone-600">
                        ...
                        {inq.productId && (
                          <span className="bg-amber-100 text-amber-800 px-2 py-0.5 rounded-full font-bold">
                            मूर्ती ID: {inq.productId}
                          </span>
                        )}
                      </div>

                      {inq.message && (
                        <p className="font-marathi text-xs text-stone-600 pt-1">
                          💬 {inq.message}
                        </p>
                      )}
                    </div>
